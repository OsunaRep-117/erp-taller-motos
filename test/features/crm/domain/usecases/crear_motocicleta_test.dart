...
void main() {
  ...
  group('CrearMotocicleta', () {
    test(
      'Sección 6.2: rechaza VIN que no tiene exactamente 17 caracteres',
      () async {
    ...
    test(
      'normaliza VIN y placa a mayúsculas antes de enviar al repositorio',
      () async {
        when(
          () => repository.crearMotocicleta(
            vin: '3HGCM82644B009913',
            placa: 'HGO-1234',
            marca: 'Honda',
            modelo: 'CB190R',
          ...
          (_) async =>
              const Left(ReglaDeNegocioFailure('no importa para este test')),
        );
