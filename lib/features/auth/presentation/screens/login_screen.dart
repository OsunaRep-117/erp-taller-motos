...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _iniciarSesionConGoogle() async {
    if (AppConfig.useMockBackend) {
      ...
      setState(
        () => _error =
            'Falta GOOGLE_WEB_CLIENT_ID en .env (requerido en Android).',
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final googleHabilitado =
        esMock ||
        (AppConfig.supabaseConfigurado &&
            (kIsWeb || AppConfig.googleWebClientId.isNotEmpty));
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    esMock ? 'Modo demo local' : 'Inicia sesión para continuar',
                  ...
                  const SizedBox(height: 16),
                  OutlinedButton.icon(
                    onPressed: _cargando || !googleHabilitado
                        ? null
...
class _GoogleIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromCenter(
        center: Offset(center.dx + radius * 0.05, center.dy),
        width: radius * 0.95,
        height: radius * 0.22,
      ),
      Paint()..color = const Color(0xFF4285F4),
