  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        routes: [
          GoRoute(path: 'crear', builder: (context, state) => const CrearOrdenScreen()),
          GoRoute(
            path: ':id',
            builder: (context, state) => OrdenDetailScreen(idOrden: state.pathParameters['id']!),
          ),
        ],
      ),
      GoRoute(
        ...
        routes: [
          GoRoute(path: 'crear', builder: (context, state) => const CrearRefaccionScreen()),
          GoRoute(path: 'ajustar', builder: (context, state) => const AjustarInventarioScreen()),
          GoRoute(
            path: ':sku',
            builder: (context, state) => RefaccionDetailScreen(sku: state.pathParameters['sku']!),
          ),
        ],
      ),
      GoRoute(path: '/compras', builder: (context, state) => const ComprasHomeScreen()),
      GoRoute(path: '/compras/recibir', builder: (context, state) => const RecibirMercanciaScreen()),
      GoRoute(path: '/compras/proveedores/crear', builder: (context, state) => const CrearProveedorScreen()),
      GoRoute(
        path: '/clientes',
        builder: (context, state) => const ClientesListScreen(),
        routes: [
          GoRoute(path: 'crear', builder: (context, state) => const CrearClienteScreen()),
          GoRoute(
            path: ':id',
            builder: (context, state) => ClienteDetailScreen(id: state.pathParameters['id']!),
          ),
        ],
      ),
      GoRoute(
        ...
        routes: [
          GoRoute(path: 'crear', builder: (context, state) => const CrearMotocicletaScreen()),
          GoRoute(
            path: ':vin',
            builder: (context, state) => MotocicletaDetailScreen(vin: state.pathParameters['vin']!),
          ),
        ],
      ),
      GoRoute(path: '/finanzas', builder: (context, state) => const FinanzasDashboardScreen()),
      GoRoute(path: '/comisiones', builder: (context, state) => const ComisionesListScreen()),
      GoRoute(
        path: '/empleados',
        builder: (context, state) => const EmpleadosListScreen(),
        routes: [
          GoRoute(path: 'crear', builder: (context, state) => const CrearEmpleadoScreen()),
          GoRoute(
            path: 'invitar-google',
    ...
    redirect: (context, state) {
      ...
      if (usuario != null && !AppPermissions.puedeAccederRuta(usuario.rol, ruta)) {
        return '/ordenes';
      }
